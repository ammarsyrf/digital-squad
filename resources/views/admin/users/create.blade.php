...
@section('title', 'Tambah User Baru - Digital Skill Passport')
...
@section('content')
    <div class="max-w-7xl mx-auto w-full">
        ...
        <nav class="flex mb-6" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        <span class="material-symbols-outlined text-slate-400 text-sm mx-1">chevron_right</span>
                        <span class="ml-1 text-sm font-medium text-slate-900 dark:text-white md:ml-2">Tambah User
                            Baru</span>
                    </div>
                </li>
            </ol>
        ...
        <!-- Page Header -->
        <div class="mb-8">
            <h2 class="text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white">Tambah User Baru</h2>
            <p class="mt-2 text-slate-600 dark:text-slate-400">Tambahkan pengguna baru ke dalam sistem.</p>
        </div>
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <select name="role" id="role" required
                            ...
                            <option value="talent" {{ old('role') == 'talent' ? 'selected' : '' }}>Talenta Digital</option>
                            <option value="umkm" {{ old('role') == 'umkm' ? 'selected' : '' }}>UMKM / Instansi</option>

                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="kesulitan" id="kesulitan" required
                                class="block w-full rounded-lg border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white focus:ring-primary focus:border-primary sm:text-sm">
                                <option value="mudah" {{ old('kesulitan', $soal->kesulitan) == 'mudah' ? 'selected' : '' }}>
                                    Mudah</option>
                                <option value="sedang" {{ old('kesulitan', $soal->kesulitan) == 'sedang' ? 'selected' : '' }}>
                                    Sedang</option>
                                <option value="sulit" {{ old('kesulitan', $soal->kesulitan) == 'sulit' ? 'selected' : '' }}>
                                    Sulit</option>
                            </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="opsi_a" id="opsi_a" value="{{ old('opsi_a', $soal->opsi_a) }}" required
                                class="block w-full rounded-lg border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white focus:ring-primary focus:border-primary sm:text-sm">
                        </div>
                        <div>
                            <label for="opsi_b"
                                class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Opsi B</label>
                            <input type="text" name="opsi_b" id="opsi_b" value="{{ old('opsi_b', $soal->opsi_b) }}" required
                                class="block w-full rounded-lg border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white focus:ring-primary focus:border-primary sm:text-sm">
                        </div>
                        <div>
                            <label for="opsi_c"
                                class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Opsi C</label>
                            <input type="text" name="opsi_c" id="opsi_c" value="{{ old('opsi_c', $soal->opsi_c) }}" required
                                class="block w-full rounded-lg border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white focus:ring-primary focus:border-primary sm:text-sm">
                        </div>
                        <div>
                            <label for="opsi_d"
                                class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Opsi D</label>
                            <input type="text" name="opsi_d" id="opsi_d" value="{{ old('opsi_d', $soal->opsi_d) }}" required
                                class="block w-full rounded-lg border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white focus:ring-primary focus:border-primary sm:text-sm">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="status" id="status" required
                                class="block w-full rounded-lg border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white focus:ring-primary focus:border-primary sm:text-sm">
                                <option value="aktif" {{ old('status', $soal->status) == 'aktif' ? 'selected' : '' }}>Aktif
                                </option>
                                <option value="nonaktif" {{ old('status', $soal->status) == 'nonaktif' ? 'selected' : '' }}>
                                    Non-Aktif</option>
                            </select>

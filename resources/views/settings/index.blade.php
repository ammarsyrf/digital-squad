...
@section('title', 'Le - Digital Skill Passport')
            ...
            <div class="p-8 space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-4">
                        ...
                        <button type="button"
                            class="px-4 py-2 border border-slate-200 dark:border-slate-700 rounded-xl text-xs font-bold hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">Ubah
                            Email</button>
                    </div>
                    <div class="space-y-4">
                        <h4 class="font-bold flex items-center gap-2 text-sm text-slate-900 dark:text-white">
                        ...
                        <button type="button"
                            class="px-4 py-2 border border-slate-200 dark:border-slate-700 rounded-xl text-xs font-bold hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">Ganti
                            Kata Sandi</button>
                    </div>
                </div>
